...
import { PRACTICE_AREAS, CONTACT_INFO, TEAM_MEMBERS } from '../lib/constants';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl md:text-2xl text-blue-100 leading-relaxed mb-8">
                  Soluções jurídicas completas com expertise, transparência e 
                  comprometimento para pessoas e empresas.
                </p>
                
                {/* CTA Buttons */}
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <a
                    href="https://wa.me/+5515991234567?text=Olá,%20gostaria%20de%20agendar%20uma%20consulta%20gratuita"
                    target="_blank"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Entre em contato agora mesmo e dê o primeiro passo para a solução 
              dos seus problemas jurídicos com profissionais especializados.
            </p>
...
function getAreaDescription(area) {
  const descriptions = {
    ...
    'Previdenciário': 'Aposentadoria, benefícios previdenciários e revisões de planos.',
